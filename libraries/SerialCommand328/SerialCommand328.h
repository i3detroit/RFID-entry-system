/******************************************************************************* 
SerialCommand328 - An Arduino library to tokenize and parse commands received over
a serial port. 
...
January 6 2014 - specialized version for the atmega328 (has max commands and delimiters at
                        a reasonable level, now it canbe used in conjunction with 
                        SerialCommand2560 which has different values (could be an ifdef)
...
***********************************************************************************/
#ifndef SerialCommand328_h
#define SerialCommand328_h
